...
public class Inimigo {
	...
	public void testeColisões() {
		...
		if(colideDireita() == true) {
			velX = 0;
			posX = Principal.limite_esquerdo - raio * 2;
		}
	}
	
	public void movimentoVertical(Bolinha bolinha) {
		velY = 0;
	...
	public boolean colideCima() {
		return posY <= 0;
	}
	
	public boolean colideBaixo() {
		return posY + (raio * 2) >= Principal.altura_tela;
	}

	public boolean colideDireita() {
		return posX + (raio * 2) >= Principal.limite_esquerdo;
	}
	
	public boolean colideEsquerda() {
		return posX <= 0;
	}
